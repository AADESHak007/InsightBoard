...
export default function EducationInsights() {
  ...
  const indicators: Indicator[] = [
    ...
    },
    {
      ...
      category: 'Education',
      description: 'Percentage of students identifying as Asian.',
      value: Math.round((data.demographicBreakdown.asian / data.stats.totalEnrollment) * 100 * 10) / 10,
      unit: '%',
      lastUpdate: new Date(data.lastUpdated).toISOString().split('T')[0],
      source: 'NYC DOE',
      color: '#10b981',
      higherIsBetter: true,
      explanation: 'Asian student population reflects cultural diversity and academic achievement patterns in NYC public schools.',
    },
    {
      id: 'edu-8',
      title: 'Hispanic/Latino Students',
      category: 'Education',
      description: 'Percentage of students identifying as Hispanic/Latino.',
      value: Math.round((data.demographicBreakdown.hispanic / data.stats.totalEnrollment) * 100 * 10) / 10,
      unit: '%',
      lastUpdate: new Date(data.lastUpdated).toISOString().split('T')[0],
      source: 'NYC DOE',
      color: '#f59e0b',
      higherIsBetter: true,
      explanation: 'Hispanic/Latino student representation in NYC public schools, reflecting the city\'s largest ethnic demographic.',
    },
    {
      id: 'edu-9',
      title: 'Black/African American Students',
      category: 'Education',
      description: 'Percentage of students identifying as Black/African American.',
      value: Math.round((data.demographicBreakdown.black / data.stats.totalEnrollment) * 100 * 10) / 10,
      unit: '%',
      lastUpdate: new Date(data.lastUpdated).toISOString().split('T')[0],
      source: 'NYC DOE',
      color: '#3b82f6',
      higherIsBetter: true,
      explanation: 'Black/African American student population, representing a significant portion of NYC\'s diverse student body.',
    },
    {
      id: 'edu-10',
      title: 'White Students',
      category: 'Education',
      description: 'Percentage of students identifying as White.',
      value: Math.round((data.demographicBreakdown.white / data.stats.totalEnrollment) * 100 * 10) / 10,
      unit: '%',
      lastUpdate: new Date(data.lastUpdated).toISOString().split('T')[0],
      source: 'NYC DOE',
      color: '#84cc16',
      higherIsBetter: true,
      explanation: 'White student representation in NYC public schools, contributing to the city\'s multicultural educational environment.',
    },
    {
      id: 'edu-11',
      title: 'Average School Size',
      category: 'Education',
      description: 'Average number of students per school.',
      value: Math.round((data.stats.totalEnrollment / data.stats.totalSchools) * 10) / 10,
      unit: 'students',
      target: 800,
      targetCondition: '<=',
      lastUpdate: new Date(data.lastUpdated).toISOString().split('T')[0],
      source: 'NYC DOE',
      trend: (data.stats.totalEnrollment / data.stats.totalSchools) <= 800 ? 'down' : 'up',
      color: '#8b5cf6',
      higherIsBetter: false,
      explanation: 'Average school size affects teacher-student ratios and personalized attention. Smaller schools often provide better individual support.',
    },
  ];
