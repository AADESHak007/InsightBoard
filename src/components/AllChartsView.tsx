  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white">NYC Insights - Visualize</h2>
          <p className="text-gray-400 mt-1">Comprehensive data visualization across all sectors</p>
        </div>
        <div className="flex items-center gap-4 text-sm text-gray-400">
          <span className="text-gray-400">Live data from NYC Open Data</span>
          <span className="text-gray-500">• Updated {new Date().toLocaleString()}</span>
        </div>
      </div>
      ...
      {business.data && (
        <div className="space-y-6">
          <h3 className="text-xl font-semibold text-white border-b border-gray-700 pb-2">Business Sector</h3>
          
          {/* Business Growth Trends - Independent Line Chart */}
          <div className="bg-[#111827] border border-[#1f2937] rounded-lg p-6">
            <div className="mb-4">
              <h4 className="text-lg font-semibold text-white">Business Growth Trends</h4>
            ...
            <LineChart
              ...
              title="Certified Businesses Over Time"
              height={400}
              color="#f59e0b"
              xAxisLabel="Year"
      ...
      {education.data && (
        <div className="space-y-6">
          <h3 className="text-xl font-semibold text-white border-b border-gray-700 pb-2">Education Sector</h3>
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
            {/* Student Demographics - Pie Chart */}
            <div className="bg-[#111827] border border-[#1f2937] rounded-lg p-6">
              <div className="mb-4">
                <h4 className="text-lg font-semibold text-white">Student Demographics</h4>
                <p className="text-sm text-gray-400 mt-1">
            ...
            <div className="bg-[#111827] border border-[#1f2937] rounded-lg p-6">
              <BarChart
                ...
                title="Student Demographics by Category"
                height={400}
      ...
      {housing.data && (
        <div className="space-y-6">
          <h3 className="text-xl font-semibold text-white border-b border-gray-700 pb-2">Housing Sector</h3>
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
      ...
      {health.data && (
        <div className="space-y-6">
          <h3 className="text-xl font-semibold text-white border-b border-gray-700 pb-2">Health Sector</h3>
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
            {/* Restaurant Grades - Pie Chart */}
            <div className="bg-[#111827] border border-[#1f2937] rounded-lg p-6">
              <div className="mb-4">
                <h4 className="text-lg font-semibold text-white">Restaurant Food Safety Grades</h4>
                <p className="text-sm text-gray-400 mt-1">
      ...
      {safety.data && (
        <div className="space-y-6">
          <h3 className="text-xl font-semibold text-white border-b border-gray-700 pb-2">Public Safety Sector</h3>
          
          {/* Crime Trends - Independent Line Chart */}
          <div className="bg-[#111827] border border-[#1f2937] rounded-lg p-6">
            <div className="mb-4">
      ...
      {environment.data && (
        <div className="space-y-6">
          <h3 className="text-xl font-semibold text-white border-b border-gray-700 pb-2">Environment Sector</h3>
          
          {/* Air Quality Trends - Independent Line Chart */}
          <div className="bg-[#111827] border border-[#1f2937] rounded-lg p-6">
            <div className="mb-4">
              <h4 className="text-lg font-semibold text-white">Air Quality Trends</h4>
              <p className="text-sm text-gray-400 mt-1">
      ...
      {transportation.data && (
        <div className="space-y-6">
          <h3 className="text-xl font-semibold text-white border-b border-gray-700 pb-2">Transportation Sector</h3>
          
          {/* Taxi Trips Trends - Independent Line Chart */}
          <div className="bg-[#111827] border border-[#1f2937] rounded-lg p-6">
            <div className="mb-4">
              <h4 className="text-lg font-semibold text-white">Taxi Trip Trends</h4>
              <p className="text-sm text-gray-400 mt-1">
